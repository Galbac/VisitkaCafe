...
/*
 ...
 4. Register the skin exclusions, to have them used on the development version of
 the skin.
 */
...
// 4. Register the skin exclusions for development purposes only
// ----------------------------------------------------------
// (http://docs.cksource.com/CKEditor_4.x/Skin_SDK/Icons)
//
// Note: As "moono" is the default CKEditor skin, it provides no custom exclusions,
// thus this code is commented out.
//
// This code is here just to make the skin work fully when using its "source"
// version. Without this, the skin will still work, but its exclusions will not be
...
// used instead. This means that a skin is not required to provide all exclusions.
// Actually, it is not required to provide exclusions at all.
//
// (function() {
//		// The available exclusions. This list must match the file names (without
//		// extension) available inside the "exclusions" folder.
//		var exclusions = ( 'about,anchor-rtl,anchor,bgcolor,bidiltr,bidirtl,blockquote,' +
...
//			'hiddenfield,horizontalrule,exclusions,iframe,image,imagebutton,indent-rtl,' +
...
//
//		var iconsFolder = CKEDITOR.getUrl( CKEDITOR.skin.path() + 'exclusions/' + ( CKEDITOR.env.hidpi ? 'hidpi/' : '' ) );
//
//		for ( var i = 0; i < exclusions.length; i++ ) {
//			CKEDITOR.skin.addIcon( exclusions[ i ], iconsFolder + exclusions[ i ] + '.png' );
//		}
// })();
